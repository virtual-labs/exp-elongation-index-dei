...
Elongation Index of Fraction (%) = (Wₑ / Wₜ) × 100

Where:
- Wₑ = Weight of elongated particles retained on gauge (g)
- Wₜ = Total weight of fraction tested (g)

 2. Overall Elongation Index
Overall Elongation Index (%) = (ΣWₑ / ΣWₜ) × 100

Where:
- ΣWₑ = Sum of elongated particles from all fractions (g)
- ΣWₜ = Total weight of all fractions tested (g)

 3. Weighted Average Method

Weighted Elongation Index (%) = Σ(Pᵢ × Eᵢ) / 100

Where:
- Pᵢ = Percentage of each size fraction in original sample (%)
- Eᵢ = Elongation index of fraction i (%)
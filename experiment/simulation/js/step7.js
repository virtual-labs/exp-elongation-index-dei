...
addEventListener("DOMContentLoaded", (evt) => {
    ...
    instructionsStep7.textContent = "Pass the aggregates through 10-6.3mm slot and separate the passing aggregates from the ones that have not passed the slot."
...
trans6Step7.addEventListener("click", (evt) => {
    ...
    gif6Step7.style.visibility = "visible";
     ...
     setTimeout(() => {
         ...
         instructionsStep7.textContent = "Weigh the aggregates passing the 10-6.3mm slot on the elongation gauge."
